...
import (
	litmusLIB "github.com/chaosnative/litmus-go/chaoslib/litmus/azure-stress-chaos/lib"
	experimentEnv "github.com/chaosnative/litmus-go/pkg/azure/stress-chaos/environment"
	...
	"github.com/chaosnative/litmus-go/pkg/result"
	"github.com/chaosnative/litmus-go/pkg/status"
...
func AzureStressChaosExperiment(clients clients.ClientSets) {
	...
	case "litmus":
		if err := litmusLIB.PrepareAzureStressChaos(&experimentsDetails, clients, &resultDetails, &eventsDetails, &chaosDetails); err != nil {
