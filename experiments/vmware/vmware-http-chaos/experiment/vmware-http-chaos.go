...
import (
	litmusLIB "github.com/chaosnative/litmus-go/chaoslib/litmus/vmware-http-chaos/lib"
	vmwarelib "github.com/chaosnative/litmus-go/pkg/cloud/vmware/vmware-http-chaos/http"
	experimentEnv "github.com/chaosnative/litmus-go/pkg/vmware/vmware-http-chaos/environment"
...
// VMWareHttpChaosExperiment contains steps to inject vmware-http-chaos
func VMWareHttpChaosExperiment(clients clients.ClientSets) {
	...
	case "litmus":
		if err = litmusLIB.InjectVMHttpChaosChaos(&experimentsDetails, clients, &resultDetails, &eventsDetails, &chaosDetails, cookie); err != nil {
